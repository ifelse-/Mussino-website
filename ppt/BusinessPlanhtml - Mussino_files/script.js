...
var gDocTable = new Array(
   ...
   new hrefList("slide0032.htm", 1, 2),
   new hrefList("slide0033.htm", 1, 3),
   new hrefList("slide0034.htm", 1, 4),
   new hrefList("slide0035.htm", 1, 5),
   new hrefList("slide0036.htm", 1, 6),
   new hrefList("slide0037.htm", 1, 7),
   new hrefList("slide0038.htm", 1, 8),
   new hrefList("slide0039.htm", 1, 9),
   new hrefList("slide0040.htm", 1, 10),
...
var g_baseURL = gtmpstr.substr(0, gtmpstr.lastIndexOf("/") ) + "/" + "BusinessPlanhtml%20-%20Mussino_files";
var g_showoutline = 1;
  ...
  if ( (msie || isnav ) && ( (os < 0 && ver >= 4 ) || ( os >= 0 && ver >= 5 ) || (os >=0 && msie < 0 && ver >= 4 ) )  ){
	if ( msie >= 0 )  {
		if ( isIEFiles > 0 )
			...
			window.location.replace(  "BusinessPlanhtml%20-%20Mussino_files/error.htm" );
	}
	else {
