		...
		new AjaxUpload(btnUpload, {
			...
			onSubmit: function(file, ext){
				 if($("#small_video_files li").children().is("img"))
				 	{
					 alert("Video already exist, Please delete before upload new one")
					 return false;
					}
				 if ( !(ext && /^(flv|FLV|mp3|MP3)$/.test(ext))){ 
				 //avi|AVI|3gp|3GP|flv|FLV|mkv|MKV|mov|MOV|mp3|MP3|mp4|MP4|mpeg|MPEG|wma|WMA|wmv|WMV
                    // extension is not allowed 
      ...
      <div class="pro-wrapper full">
       ...
       <div class="creditBox">
        ...
        <p class="creditTxt"></p>
         ...
         <br />
        <p style="margin-top:10px;">Mussino fee 0%. <br /><br /><a href="http://www.mussino.com/product.php">Try create a session</a><br />Ex: 1 session x 100 songwriters credits = $100 </p>
             ...
             <div class="form-container">
              <ul>
                ...
                <li>
                  ...
                  <div class="caption-2">Beat Name</div>
                  <div class="input-2">
                ...
                <BR />
                <li class="formBG">
                  <div class="caption-2" style="width:400px;">Description or License agreement (optional)</div>
                ...
                <br />
                <li class="formBG2" style="width:600px;">
                  <div class="caption-2">Image</div>
                  <div class="input-2"><div id="imageupload"></div><span id="imagestatus" ></span><span style="font-family:Arial, Helvetica, sans-serif; font-size:11px; color:#fff"><strong> For best look [ Image Dimensions 200 x 200 or Size 300 KB  ]</strong></span></div>
                  <div class="cl"></div>
                </li>
                <li>
                ...
                <li class="formBG" style="width:620px;">
                  <div class="caption-2" style="width:300px;">Music Audio or Music Video</div>
                  <div class="input-2"><div id="small_video_upload" >&nbsp;</div><span id="small_video_status" ></span>
               </div>
    <div class="cl"></div>
    <span style="font-family:Arial, Helvetica, sans-serif; font-size:14px; color: #069"><strong><!--[ only upload avi, 3gp, flv, mkv, mov, mp3, mp4, mpeg, wma, wmv ]--> 
     <br />
                [Please use mp3 only]
                 <br />
                </li>
