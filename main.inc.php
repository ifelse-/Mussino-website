...
<div class="content-box-2">
 ...
 <!-- Colloge -->
 <!--<div id="iphone_switch">
 <div class="RIGHT" id="1"></div> <div class="RIGHT" style="padding:12px 0 0 0; font-size:11px; color:#09C;"><strong>Studio</strong>&nbsp;</div>
  <div class="clear"></div>
  ...
  <script type="text/javascript">
    ...
    $('#1').iphoneSwitch("on", 
     function() {  
    $('#showhide_session').fadeOut('fast', function(){
          $('#colloge_wrap').fadeIn('fast'); $('#showhide_session').fadeIn('fast');
    });
	
	 },
      function() {
   
	 $('#colloge_wrap').fadeOut('fast', function(){
         $('#showhide_session').fadeIn('fast');
    });
      },
      {
...
<div id="showhide_session">
<img src="images/thingsyouknow.png" class="LEFT"/>

<div class="CLEAR"></div>

<div class="LEFT bottomM">
<a href="http://mussino.com/registration.php"><img src="images/coll_1.png" /></a>
...
<div class="LEFT">
<img src="images/coll_2.png" />
<br />
<img src="images/coll_3.png" class="topM"/>
</div>

<div class="RIGHT">
<img src="images/coll_4.png" />
</div>
        ...
        <div class="pro-wrapper fl">
          ...
          <div class="title">
            <div class="title_wrap-1">
              <div class="title_wrap-2">
                ...
                <img src="images/speaker_icon.png" align="top" class="videoimg" width="35"/> Mussino payout to winners <strong>$1,458.00</strong> ending Nov 30. Not a member yet? <a href="http://www.mussino.com/registration.php"><strong>Register now</strong>.</a> 
              </div>
            </div>
          </div>
            <?php
			...
			if($_GET['cat_id']!='')
			{
			$sql = "SELECT P.Product_Id, P.Member_Account_Id, P.Category_Id,P.Royalties, P.Posts,P.Judges_Vote,	P.Title, P.Product_Notes, P.Sound, P.Type, P.Image_Name, P.Short_FIle_Name, P.Long_FIle_Name, P.Short_Desc, P.Long_Desc, P.Price, P.Session_Start_Date, P.Session_End_Date, DATE_FORMAT(P.Session_Start_Date,'%m/%d/%Y %h:%i %p') as StartDate, DATE_FORMAT(P.Session_End_Date,'%m/%d/%Y %h:%i %p') as EndDate, P.Product_Date, P.Status, P.Jack_Pot, P.Jack_Pot_Status FROM product_master P LEFT JOIN product_category_master PC ON (P.Product_Id=PC.Product_Id) WHERE P.Status=1 AND PC.Category_Id='".$_GET['cat_id']."' AND now() between P.Session_Start_Date AND P.Session_End_Date  GROUP BY P.Product_Id ORDER BY P.Category_Id";
			}
			elseif($_GET['sound']!='')
			{
			$sql = "SELECT P.Product_Id, P.Member_Account_Id, P.Category_Id,P.Royalties, P.Posts,P.Judges_Vote,	P.Title, P.Product_Notes, P.Sound, P.Type, P.Image_Name, P.Short_FIle_Name, P.Long_FIle_Name, P.Short_Desc, P.Long_Desc, P.Price, P.Session_Start_Date, P.Session_End_Date, DATE_FORMAT(P.Session_Start_Date,'%m/%d/%Y %h:%i %p') as StartDate, DATE_FORMAT(P.Session_End_Date,'%m/%d/%Y %h:%i %p') as EndDate, P.Product_Date, P.Status, P.Jack_Pot, P.Jack_Pot_Status FROM product_master P  WHERE P.Status=1 AND P.Sound = '".$_GET['sound']."' AND now() between P.Session_Start_Date AND P.Session_End_Date  GROUP BY P.Product_Id ORDER BY P.Sound";
			}
			else
			{
			$sql = "SELECT P.Product_Id, P.Member_Account_Id,P.Title,P.Royalties, P.Posts, P.Judges_Vote, P.Category_Id, P.Product_Notes, P.Sound, P.Type, P.Image_Name, P.Short_FIle_Name, P.Long_FIle_Name, P.Short_Desc, P.Long_Desc, P.Price, P.Session_Start_Date, P.Session_End_Date, DATE_FORMAT(P.Session_Start_Date,'%m/%d/%Y %h:%i %p') as StartDate, DATE_FORMAT(P.Session_End_Date,'%m/%d/%Y %h:%i %p') as EndDate, P.Product_Date, P.Status, P.Jack_Pot, P.Jack_Pot_Status FROM product_master P WHERE P.Status=1 AND now() between P.Session_Start_Date AND P.Session_End_Date ORDER BY P.Category_Id";
			}
              ...
              <div class="pro-box_wrap-2">
                <div class="pro-box_wrap-3">
                  ...
                  <div class="pro-info">
                    <ul>
                      <li>
                        ...
                        <div class="detail-1">
                        <a href="<?=SITE_WS_PATH?>/<?=trim($colles['Member_Account_Id'])?>/<?=ucfirst(stripslashes(Get_Single_Field("member_account_master","First_Name","Member_Account_Id","$colles[Member_Account_Id]")))?>" >
						<?=stripslashes(ucfirst(Get_Single_Field("member_account_master","First_Name","Member_Account_Id","$colles[Member_Account_Id]")))?>
                        </a></div>
                        <div class="cl"></div>
                      </li>
                  ...
                  <div class="jackpot">
                   ...
                   <?php if($colles['Type']!='3') {  ?> <img src="<?=SITE_WS_PATH?>/images/moneyBag.jpg" width="25" style="margin-top:-4px; position: absolute;" /><span><span style="margin-left:30px; padding:4px; color:#069;">Royal Jackpot: <span class="royalvalue">$<?=$TOTAL_ROYALTIES?></span></span></span> <?php } else { ?> <span><span>$<?=trim($colles['Price'])?></span></span><?php } ?>
                  </div>
                  <?php if($colles['Type']!='3') { ?>
                  <div class="time">
          ...
          <div class="btn-row">
			...
			<?php } else { // EI 2.0 ?>
                  ...
                  <?php if(mysql_num_rows($result_bank_artist)>=2 && $colles['Judges_Vote']==0) { ?>
