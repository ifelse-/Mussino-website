...
$sql_sound_type1 = " FROM product_master  WHERE Status=1  AND Type=3 AND New_Music_Releases!=1";
  ...
  <div class="layoutArea">
    ...
    <div class="content-box-2">
        ...
        <div class="dark-gray_wrap">
          <h3>Top New Instrumental Releases</h3>
          
          <div class="fl">
          <?php
		    $new_cn =0;
			$sql_sound_type = "SELECT * FROM product_master WHERE Status=1 AND Type=3 AND New_Music_Releases=1 ORDER BY rand() LIMIT 0,4";
            ...
            <div class="new-albm">
              <a href="#"> <?php if(file_exists("products/product_image/$colles_sound_type[Image_Name]") && $colles_sound_type['Image_Name']!='') { ?>
                <img src="products/product_image/<?php echo $colles_sound_type['Image_Name']; ?>" border="0" width="100px;" height="100px;"  alt="<?=stripslashes($colles_sound_type['Title'])?>"/>
                <?php } else { ?>
                <img src="images/no-image.png" border="0" width="100px;" height="100px" alt="<?=stripslashes($colles_sound_type['Title'])?>"/>
                <?php } ?> </a>
              ...
              <div class="gray-btn-2">
                <a href="music-store.php?id=<?=$colles_sound_type['Product_Id']?>">Edit Me</a>
              </div>
              <?php } else { ?>
              <div class="gray-btn-2">
                <a href="buy-unreleased-music-to-cart.php?id=<?=$colles_sound_type['Product_Id']?>">Download Now</a>
              </div>
              <?php } } ?>
            </div>
        ...
        <div class="genre-wrap">
          ...
          <div class="genre-col">
            <h3>Latest Instrumental Releases</h3>
             <div class="newReleaseTxt">
     Instrumentals in this section are for direct buy and have not been used in sessions. These are new releases from Musicians around the world. Once you purchase an exclusive instrumental, you are instantly able to print and download a written licensing agreement. Once the instrumental is licensed to you, you are able to use the instrumental for your demo, mix tape, album etc. Be sure to see terms and conditions if you are interested in more details or send an e-mail to customer service if you have any questions beyond the list terms.
            </div>
            <br />
            ...
            <div class="genre-block">
              ...
              <div class="gray-btn-2">
                <a href="music-store.php?id=<?=$colles_sound_type1['Product_Id']?>">Edit Me</a>
              </div>
              <?php } else { ?>
              
              <div class="black-btn">
              <span><span><!--<a class="global-box" onclick="window.open('preview-player.php?id=<?=$colles_sound_type1['Product_Id']?>','Preview','top=200,right=200,scrollbars=no,menubar=no,height=395,width=665,resizable=no,toolbar=no,location=no,status=no');" href="javascript:void(0);">Preview</a>-->
              ...
              <div class="gray-btn-2">
                <a href="buy-unreleased-music-to-cart.php?id=<?=$colles_sound_type1['Product_Id']?>">Download Now</a>
              </div>
              <?php } } ?>
              <div class="cl"></div>
            </div>
        ...
        <div class="catTitle">Categories</div>
          <ul>
			...
			?>
            <li class="<?=$class?>"><a href="category.php?id=<?=$colles_cat['Category_Id']?>"><?=ucfirst($colles_cat['Category_Name'])?></a></li>
            <?php
			$cu++;
			$j++;
			}
      ...
      <div class="storebottom_Banner">
      <p>Advertise Here</p>
      <img src="images/mussino_banner780x90.jpg" />
      <p>Advertise Here</p>
      </div>
