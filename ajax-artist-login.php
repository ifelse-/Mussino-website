...
require_once "config/functions.inc.php";
	...
	else
	{
		...
		$sql = "SELECT * FROM member_account_master WHERE  Email='".$_REQUEST['Email']."' AND Password='".base64_encode(addslashes(trim($_REQUEST['Password'])))."' AND Account_Type='".$_REQUEST['type']."'";
