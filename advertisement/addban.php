...
$linkr = $_POST['linksrc'];
	...
	{
		$result1 = mysql_query("insert into banners values('$bname','$imager','$linkr','banner','')",$link);
		if($result1)
...
<font color=black><b>
Use this form to add new banners for rotation.</b></font>
...
<tr><td></td><td>Ex: ./images/image1.jpg &nbsp;&nbsp;&nbsp;&nbsp;"or" <br>http://www.hscripts.com/xyxyxyx.jpg</td></tr>
<tr><td>&nbsp; </td><td> </td></tr>
...
<form name=addf action="edit.php?adtype=banner" method=POST>
