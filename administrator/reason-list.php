...
if($_GET['order_by']=='') { $order_by="Reason_Name"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM reason_master WHERE 1=1  ";


if($_REQUEST['alphabet']!='')
{
$sql.= " and Reason_Name like '". $_GET['alphabet'] ."%'";
}

if($_REQUEST['Reason_Name']!='')
{
$Reason_Name = addslashes($_REQUEST['Reason_Name']);
$sql.= " and Reason_Name like '%$Reason_Name%'";
}
      ...
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              <td width="150" align="left" valign="middle">Reason :</td>
              <td align="left" valign="top" class="input-1">
              <input type="text" name="Reason_Name" size="40"  value="<?=stripslashes($_REQUEST['Reason_Name'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="reason.php" class="lin2">Add New Reason</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="250" align="center" valign="top">Category Name  <?=sort_arrows('Reason_Name')?></th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['Reason_Id']?>" />  </td>
              <td width="250" align="center" valign="top" ><?=stripslashes(trim($row['Reason_Name']));?></td>
              ...
              <a href="reason.php?id=<?=$row['Reason_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  
              </td>
