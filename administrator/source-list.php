...
if($_GET['order_by']=='') { $order_by="Source_Name"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM source_link_master WHERE 1=1 ";
	
if($_REQUEST['alphabet']!='')
{
$sql.= " and Source_Name  like '". $_GET['alphabet'] ."%'";
}

if($_REQUEST['Source_Name']!='')
{
$Source_Name = addslashes($_REQUEST['Source_Name']);
$sql.= " and Source_Name like '%$Source_Name%'";
}
      ...
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              <td width="150" align="left" valign="middle">Source Name :</td>
              <td align="left" valign="top" class="input-1">
              <input type="text" name="Source_Name" size="40"  value="<?=stripslashes($_REQUEST['Source_Name'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="source.php" class="lin2">Add New Source</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="200" align="center" valign="top">Source Name  <?=sort_arrows('Source_Name')?></th>
              <th width="250" align="center" valign="top">Source Link  </th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['Source_Id']?>" />  </td>
              <td width="200" align="center" valign="top"><?=stripslashes(trim($row['Source_Name']));?></td>
              <td width="250" align="center" valign="top"><?=trim($row['Source_Link']);?></td>
              <td width="50" align="left" valign="top" class="<?=($row['Status']=='1')? 'enable-1':'disable-1';?>">
              <?=($row['Status']=="1")? 'Active':'Inactive';?>
              </td>
            
              <td width="50" align="center" valign="top"><a href="source.php?id=<?=$row['Source_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
