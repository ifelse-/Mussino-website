...
if($_GET['order_by']=='') { $order_by="City_Name"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM city_master WHERE 1=1 ";
	
if($_REQUEST['alphabet']!='')
{
$sql.= " and City_Name like '". $_GET['alphabet'] ."%'";
}
      ...
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              <td width="150" align="left" valign="middle">City :</td>
              <td align="left" valign="top" class="input-1">
              <input type="text" name="City_Name" size="40"  value="<?=stripslashes($_REQUEST['City_Name'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="city.php" class="lin2">Add New City</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="150" align="center" valign="top">Country  <?=sort_arrows('Country_Id')?></th>
              <th width="150" align="center" valign="top">State  <?=sort_arrows('State_Id')?></th>
              <th width="150" align="center" valign="top">City  <?=sort_arrows('City_Name')?></th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['City_Id']?>" />  </td>
              <td width="150" align="center" valign="top"><?=stripslashes(trim(Get_Single_Field("country_master","Country_Name","Country_Id","$row[Country_Id]")));?></td>
              <td width="150" align="center" valign="top"><?=stripslashes(trim(Get_Single_Field("state_master","State_Name","State_Id","$row[State_Id]")));?></td>
              <td width="150" align="center" valign="top"><?=stripslashes(trim($row['City_Name']));?></td>
              <td width="50" align="left" valign="top" class="<?=($row['Status']=='1')? 'enable-1':'disable-1';?>">
              <?=($row['Status']=="1")? 'Active':'Inactive';?>
              </td>
            
              <td width="50" align="center" valign="top"><a href="city.php?id=<?=$row['City_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
