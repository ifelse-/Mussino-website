...
$sql=" FROM product_history_master a LEFT JOIN product_master b ON(a.Product_Id=b.Product_Id) LEFT JOIN member_account_master c ON(a.Member_Account_Id=c.Member_Account_Id) WHERE 1=1 AND a.Mode=4 ";
