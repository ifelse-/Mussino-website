...
if($_GET['order_by']=='') { $order_by="First_Name"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM member_account_master WHERE 1=1 AND Account_Type!='ADMIN'";
	
if($_REQUEST['alphabet']!='')
{
$sql.= " and First_Name like '". $_GET['alphabet'] ."%'";
}

if($_REQUEST['Name']!='')
{
$Name = trim($_REQUEST['Name']);
$sql.= " and (First_Name like '%$Name%' ||  Last_Name like '%$Name%')";
}

if($_REQUEST['Account_Type']!='')
{
$Account_Type = addslashes($_REQUEST['Account_Type']);
$sql.= " and Account_Type like '%$Account_Type%' ";
}
    ...
    <div class="detail-col fr">
      <div class="detail-col_inner">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
             ...
             <tr>
              ...
              <td align="left" valign="top" class="input-1">
                <select name="Account_Type" class="textbox" >
                <option value="">Select</option>
                <option value="Artist" <? if($_REQUEST['Account_Type']=='Artist') { echo "SELECTED";}?>>Artist</option>
                <option value="Contest Judge" <? if($_REQUEST['Account_Type']=='Contest Judge') { echo "SELECTED";}?>>Contest Judge</option>
                <option value="Musician" <? if($_REQUEST['Account_Type']=='Musician') { echo "SELECTED";}?>>Musician</option>
                </select>             
             </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="member.php" class="lin2">Add New Member</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="200" align="center" valign="top">Email  <?=sort_arrows('Email')?></th>
              <th width="100" align="center" valign="top">Name  <?=sort_arrows('First_Name')?></th>
              <th width="200" align="center" valign="top">Paypal Email  </th>
              <th width="100" align="center" valign="top">Type  <?=sort_arrows('Account_Type')?></th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['Member_Account_Id']?>" />  </td>
              <td width="200" align="center" valign="top"><?=stripslashes(trim($row['Email']));?></td>
              <td width="100" align="center" valign="top"><?=stripslashes(trim($row['First_Name']));?></td>
              <td width="200" align="center" valign="top"><?=stripslashes(trim($row['Paypal_Email']));?></td>
              <td width="100" align="center" valign="top"><?=stripslashes(trim($row['Account_Type']));?></td>
              ...
              <td width="50" align="center" valign="top"><a href="member.php?id=<?=$row['Member_Account_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
