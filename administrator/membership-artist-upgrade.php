...
$list_page ='membership-artist-upgrade-list.php';
$head_page ='membership-artist-upgrade.php';
...
{ 
  ...
  if($_REQUEST['id']!='')
	{
		$sql = "SELECT * FROM membership_artist_upgrade_master WHERE Membership_Package_Name = '$Membership_Package_Name'  AND Membership_Upgrade_Id !='".$_REQUEST['id']."'";
		...
		{	
			$sql = "UPDATE membership_artist_upgrade_master SET 
	...
	else
	{
			...
			$sql = "SELECT * FROM membership_artist_upgrade_master WHERE Membership_Package_Name = '$Membership_Package_Name'  ";
			$result = mysql_query($sql) or die('<br>'.$sql.'<br>'.mysql_error());
			if(mysql_num_rows($result)>0)
			{
				$_SESSION['sess_mess'] = "Membership upgrade package already exist";
			...
			else
			{
				...
				$sql = "INSERT INTO membership_artist_upgrade_master SET
						Membership_Package_Name = '$Membership_Package_Name',
						Membership_Package_Amount 	 = '$Membership_Package_Amount',
						Membership_No = '$Membership_No',
						Membership_Package_Desc = '$Membership_Package_Desc',
...
if($_GET['id']!='')
{
$sql = "SELECT * FROM membership_artist_upgrade_master WHERE Membership_Upgrade_Id ='".$_GET['id']."'";
$result = mysql_query($sql) or die('<br>'.$sql.'<br>'.mysql_error());
  ...
  <div class="content-container">
    ...
    <div class="detail-col fr">
      <div class="detail-col_inner">
       ...
       <div class="box-1">
       <h2>Artist Upgrade Membership Package <?=$_GET['id']!='' ? 'Edit' : 'Add';?></h2>
