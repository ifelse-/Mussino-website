...
if(count($_POST['ids'])>0)
{
	...
	if($_POST['Submit']=='Delete')  
	{
	 ...
	 $sql = "DELETE FROM advertise_plan_master WHERE Advertise_Plan_Id   in (".$ids.") ";  
	 executeQuery($sql);
	...
	{
	  $sql = "UPDATE advertise_plan_master  SET Status='1' WHERE Advertise_Plan_Id  in (".$ids.")";
	  executeQuery($sql);
   ...
   {
    $sql = "UPDATE advertise_plan_master SET Status='0' WHERE Advertise_Plan_Id   in (".$ids.")";
    executeQuery($sql);
