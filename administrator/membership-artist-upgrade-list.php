...
$column="SELECT * ";
$sql=" FROM membership_artist_upgrade_master WHERE 1=1 ";
...
if(comb=='Delete'){
	...
	{
		form1.action = "upgrade-artist-membership-package-del.php";
		form1.submit();
	}
	else{ 
	return false;
  ...
  <div class="content-container">
    ...
    <div class="detail-col fr">
      <div class="detail-col_inner">
        <div class="box-1">
          <h2>Artist Upgrade Membership</h2>
        ...
        <tr align="right">
		 ...
		 <a href="membership-artist-upgrade.php" class="lin2">Add New Artist Upgrade Membership Package</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              ...
              <td width="50" align="center" valign="top"><a href="membership-artist-upgrade.php?id=<?=$row['Membership_Upgrade_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
