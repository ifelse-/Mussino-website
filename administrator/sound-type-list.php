...
if($_GET['order_by']=='') { $order_by="Sound_Type_Name"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM sound_type_master WHERE 1=1  ";


	
if($_REQUEST['alphabet']!='')
{
$sql.= " and Sound_Type_Name like '". $_GET['alphabet'] ."%'";
}

if($_REQUEST['Sound_Type_Name']!='')
{
$Sound_Type_Name = addslashes($_REQUEST['Sound_Type_Name']);
$sql.= " and Sound_Type_Name like '%$Sound_Type_Name%'";
}
...
if(comb=='Delete'){
	...
	{
		form1.action = "sound-type-del.php";
		form1.submit();
	}
	else{ 
	return false;
      ...
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              <td width="150" align="left" valign="middle">Sound Type :</td>
              <td align="left" valign="top" class="input-1">
              <input type="text" name="Sound_Type_Name" size="40"  value="<?=stripslashes($_REQUEST['Sound_Type_Name'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="sound-type.php" class="lin2">Add New Sount Type</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="250" align="center" valign="top">Sound Type Name  <?=sort_arrows('Sound_Type_Name')?></th>
              <th width="250" align="center" valign="top">Sound Type </th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['Sound_Type_Id']?>" />  </td>
              <td width="250" align="center" valign="top" ><?=stripslashes(trim($row['Sound_Type_Name']));?></td>
              <td width="250" align="center" valign="top" ><?=stripslashes(trim($row['Sound_Type']));?></td>
              <td width="50" align="left" valign="top" class="<?=($row['Status']=='1')? 'enable-1':'disable-1';?>">
              <?=($row['Status']=="1")? 'Active':'Inactive';?>
              </td>
            
              <td width="50" align="center" valign="top">
              <a href="sound-type.php?id=<?=$row['Sound_Type_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  
