...
if($_GET['order_by']=='') { $order_by="Package_History_Id"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT a.*,b.*,c.* ";
$sql=" FROM package_history_master a LEFT JOIN package_master b ON(a.Package_Id=b.Package_Id) LEFT JOIN member_account_master c ON(a.Member_Account_Id=c.Member_Account_Id) WHERE 1=1 ";
        ...
        <tr align="right">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="200" align="center" valign="top">Package</th>
