...
if($_GET['order_by']=='') { $order_by="Country_Name"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM country_master WHERE 1=1 ";
	
if($_REQUEST['alphabet']!='')
{
$sql.= " and Country_Name like '". $_GET['alphabet'] ."%'";
}
      ...
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              <td width="150" align="left" valign="middle">Country :</td>
              <td align="left" valign="top" class="input-1">
              <input type="text" name="Country_Name" size="40"  value="<?=stripslashes($_REQUEST['Country_Name'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="country.php" class="lin2">Add New Country</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="450" align="center" valign="top">Country  <?=sort_arrows('Country_Name')?></th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['Country_Id']?>" />  </td>
              <td width="450" align="center" valign="top"><?=stripslashes(trim($row['Country_Name']));?></td>
              <td width="50" align="left" valign="top" class="<?=($row['Status']=='1')? 'enable-1':'disable-1';?>">
              <?=($row['Status']=="1")? 'Active':'Inactive';?>
              </td>
            
              <td width="50" align="center" valign="top"><a href="country.php?id=<?=$row['Country_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
