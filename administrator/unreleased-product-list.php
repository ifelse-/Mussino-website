    ...
    <div class="detail-col fr">
      <div class="detail-col_inner">
        ...
        <tr align="right">
		 ...
		 <a href="unreleased-product.php" class="lin2">Add New Unreleased Product</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              ...
              <td width="50" align="center" valign="top"><a href="unreleased-product.php?id=<?=$row['Product_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
