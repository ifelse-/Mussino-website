...
qq.FileUploader.prototype = {
    ...
    _createUploadHandler: function(){
        ...
        var handler = new qq[handlerClass]({
            ...
            onComplete: function(id, fileName, result){
                ...
                ////////////////////////Mritunjay Code Modification..............................................
                if (result.success){
				var fileElement = self._getElement(item, 'file');
				//alert(self._element.id);
                //fileElement.innerHTML="<img src="+self._formatFileName(result.fileName)+">";
				returnImages=result.Images.replace( /&lt;/g, '<' );
				returnImages=returnImages.replace( /&gt;/g, '>' );
				returnImages=returnImages.replace( /&amp;nbsp;/g, '&nbsp;' );
				//alert(returnImages);
				fileElement.innerHTML=returnImages;
				fileElement.innerHTML +="<input type='hidden' name='"+self._element.id+"' value='"+result.fileName+"'>";
				fileElement.innerHTML +="<img id=\"DelImage\" style=\"cursor:pointer;\" src=\"../images/delete-icn.gif\" onclick=\"deleteImage('"+result.fullPath+"','delsmallProductImage.php','#"+self._element.id+"','')\" border=\"0\" title=\"Delete Product Thumbnail\">";
				//qq._addToList(id, result.fileName);
    ...
    _uploadFile: function(fileContainer){            
		...
		//alert($("#"+this._element.id+" li span").html());
		if($("#"+this._element.id+" li span").children().is("img"))
		   {
			 alert("Thumbnail already exist, Please delete before upload new one");
			 return false;
		   }
		if($("#"+this._element.id+"view li").children().is("img"))
		   {
			 alert("Thumbnail already exist, Please delete before upload new one");
			 return false;
		   }
...
qq.setText = function(element, text){
    ...
    element.textContent = text;   ////////////Code Modification By Mritunjay
