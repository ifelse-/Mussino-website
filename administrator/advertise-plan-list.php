...
if($_GET['order_by']=='') { $order_by="Ad_Plan_Name"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM advertise_plan_master WHERE 1=1 ";
	
if($_REQUEST['alphabet']!='')
{
$sql.= " and Ad_Plan_Name like '". $_GET['alphabet'] ."%'";
}

if($_REQUEST['Ad_Plan_Name']!='')
{
$Ad_Plan_Name = addslashes($_REQUEST['Ad_Plan_Name']);
$sql.= " and Ad_Plan_Name like '%$Ad_Plan_Name%'";
}
...
if(comb=='Delete'){
	...
	{
		form1.action = "advertise-plan-del.php";
		form1.submit();
	}
	else{ 
	return false;
      ...
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              <td width="150" align="left" valign="middle">Plan :</td>
              <td align="left" valign="top" class="input-1">
              <input type="text" name="Ad_Plan_Name" size="40"  value="<?=stripslashes($_REQUEST['Ad_Plan_Name'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="advertise-plan.php" class="lin2">Add New Advertise Plan</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="200" align="center" valign="top">Plan  <?=sort_arrows('Ad_Plan_Name')?></th>
              <th width="100" align="center" valign="top">Duration </th>
              <th width="100" align="center" valign="top">Price </th>
              <th width="100" align="center" valign="top">Date <?=sort_arrows('Ad_Plan_Date')?></th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['Advertise_Plan_Id']?>" />  </td>
              <td width="200" align="center" valign="top"><?=stripslashes(trim($row['Ad_Plan_Name']));?></td>
              <td width="100" align="center" valign="top"><?=$row['Ad_Plan_Duration'];?></td>
              <td width="100" align="center" valign="top"><?=$row['Ad_Plan_Amount'];?></td>
              <td width="100" align="center" valign="top"><?=get_date_format($row['Ad_Plan_Date']);?></td>
              <td width="50" align="left" valign="top" class="<?=($row['Status']=='1')? 'enable-1':'disable-1';?>">
              <?=($row['Status']=="1")? 'Active':'Inactive';?>
              </td>
            
              <td width="50" align="center" valign="top"><a href="advertise-plan.php?id=<?=$row['Advertise_Plan_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
