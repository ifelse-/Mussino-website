...
if($_GET['order_by']=='') { $order_by="Package_Name"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM package_master WHERE 1=1 ";
	
if($_REQUEST['alphabet']!='')
{
$sql.= " and Package_Name like '". $_GET['alphabet'] ."%'";
}

if($_REQUEST['Package_Name']!='')
{
$Package_Name = addslashes($_REQUEST['Package_Name']);
$sql.= " and Package_Name like '%$Package_Name%'";
}
      ...
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              <td width="150" align="left" valign="middle">Package :</td>
              <td align="left" valign="top" class="input-1">
              <input type="text" name="Package_Name" size="40"  value="<?=stripslashes($_REQUEST['Package_Name'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="package.php" class="lin2">Add New Package</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="200" align="center" valign="top">Package  <?=sort_arrows('Package_Name')?></th>
              <th width="100" align="center" valign="top">Notes </th>
              <th width="100" align="center" valign="top">Price </th>
              <th width="100" align="center" valign="top">Date <?=sort_arrows('Package_Date')?></th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['Package_Id']?>" />  </td>
              <td width="200" align="center" valign="top"><?=stripslashes(trim($row['Package_Name']));?></td>
              <td width="100" align="center" valign="top"><?=$row['No_Of_Package'];?></td>
              <td width="100" align="center" valign="top"><?=$row['Package_Amount'];?></td>
              <td width="100" align="center" valign="top"><?=get_date_format($row['Package_Date']);?></td>
              <td width="50" align="left" valign="top" class="<?=($row['Status']=='1')? 'enable-1':'disable-1';?>">
              <?=($row['Status']=="1")? 'Active':'Inactive';?>
              </td>
            
              <td width="50" align="center" valign="top"><a href="package.php?id=<?=$row['Package_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
