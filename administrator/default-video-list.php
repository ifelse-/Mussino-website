...
$column="SELECT * ";
$sql=" FROM default_video_master WHERE 1=1 ";
...
{
if(comb=='Inactive'){
form1.action = "default-video-del.php";
form1.submit();
}
else if(comb=='Active'){
form1.action = "default-video-del.php";
        ...
        <tr align="right">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="200" align="center" valign="top">Default Audio Or Video Name<?=sort_arrows('Video_Name')?></th>
              <th width="200" align="center" valign="top">Default Audio Or Video File</th>
            ...
            <tr>
              ...
              <td width="50" align="center" valign="middle"><a href="default-video.php?id=<?=$row['Video_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
