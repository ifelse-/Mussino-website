...
if($_GET['order_by']=='') { $order_by="Agentname"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM addagent WHERE 1=1 ";
	
if($_REQUEST['alphabet']!='')
{
$sql.= " and Agentname like '". $_GET['alphabet'] ."%'";
}
      ...
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              <td width="150" align="left" valign="middle">Agent :</td>
              <td align="left" valign="top" class="input-1">
              <input type="text" name="Agentname" size="40"  value="<?=stripslashes($_REQUEST['Agentname'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="agent.php" class="lin2">Add New Agent</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="250" align="center" valign="top">Agent Name  <?=sort_arrows('Agentname')?></th>
               <th width="200" align="center" valign="top">Commision</th>
            ...
            <tr>
              ...
              <td width="250" align="center" valign="top"><?=stripslashes(trim($row['Agentname']));?></td>
              <td width="200" align="center" valign="top"><a href="commision.php?id=<?=$row['Id']?>">View</a></td>
              <td width="50" align="left" valign="top" class="<?=($row['Status']=='1')? 'enable-1':'disable-1';?>">
              <?=($row['Status']=="1")? 'Active':'Inactive';?>
              </td>
            
              <td width="50" align="center" valign="top"><a href="agent.php?id=<?=$row['Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
