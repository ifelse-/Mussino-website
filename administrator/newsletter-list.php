...
if($_GET['order_by']=='') { $order_by="Subject"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM newsletter WHERE 1=1 ";
	
if($_REQUEST['alphabet']!='')
{
$sql.= " and Subject like '". $_GET['alphabet'] ."%'";
}
...
if(comb=='Delete'){
	...
	{
		form1.action = "newsletter-del.php";
		form1.submit();
	}
	else{ 
	return false;
    ...
    <div class="detail-col fr">
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              ...
              <input type="text" name="Subject" size="40"  value="<?=stripslashes($_REQUEST['Subject'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="newsletter.php" class="lin2">Add New Newsletter</a> &nbsp;&nbsp;<a href="newsletter-mail.php" class="lin2">Send Newsletter</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="350" align="center" valign="top">Subject </th>
              <th width="100" align="center" valign="top">From </th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['N_Id']?>" />  </td>
              <td width="350" align="center" valign="top"><?=stripslashes(trim($row['Subject']));?></td>
              <td width="100" align="center" valign="top"><?=stripslashes(trim($row['From_Mail']));?></td>
              <td width="50" align="left" valign="top" class="<?=($row['Status']=='1')? 'enable-1':'disable-1';?>">
              <?=($row['Status']=="1")? 'Active':'Inactive';?>
              </td>
            
              <td width="50" align="center" valign="top"><a href="newsletter.php?id=<?=$row['N_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
