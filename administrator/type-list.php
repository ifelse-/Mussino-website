...
if($_GET['order_by']=='') { $order_by="Type_Name"; } else { $order_by=$_REQUEST['order_by'];}
if($_GET['order_by2']=='') { $order_by2="DESC"; } else { $order_by2=$_REQUEST['order_by2'];}


$column="SELECT * ";
$sql=" FROM type_master WHERE 1=1 ";
	
if($_REQUEST['alphabet']!='')
{
$sql.= " and Type_Name like '". $_GET['alphabet'] ."%'";
}

if($_REQUEST['Type_Name']!='')
{
$Type_Name = addslashes($_REQUEST['Type_Name']);
      ...
      <div class="detail-col_inner">
        <div class="box-1">
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            ...
            <tr>
              <td width="150" align="left" valign="middle">Type :</td>
              <td align="left" valign="top" class="input-1">
              <input type="text" name="Type_Name" size="40"  value="<?=stripslashes($_REQUEST['Type_Name'])?>" class="textbox"/>              </td>
            </tr>
        ...
        <tr align="right">
		 ...
		 <a href="type.php" class="lin2">Add New Type</a>
          </td>
           <? if($reccnt<=0) { ?>
		  </tr>
          ...
          <table width="100%" border="0" cellspacing="0" cellpadding="0" class="table-1">
            <tr>
              ...
              <th width="450" align="center" valign="top">Type  <?=sort_arrows('Type_Name')?></th>
			...
			?>
            <tr>
              <td width="50" align="center" valign="top"><input name="ids[]" type="checkbox" value="<?=$row['Type_Id']?>" />  </td>
              <td width="450" align="center" valign="top"><?=stripslashes(trim($row['Type_Name']));?></td>
              <td width="50" align="left" valign="top" class="<?=($row['Status']=='1')? 'enable-1':'disable-1';?>">
              <?=($row['Status']=="1")? 'Active':'Inactive';?>
              </td>
            
              <td width="50" align="center" valign="top"><a href="type.php?id=<?=$row['Type_Id']?>"><img src="images/editrec.gif" width="12" height="12" border="0"></a>  </td>
