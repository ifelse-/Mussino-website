...
if(count($_POST['ids'])>0)
{
	...
	if($_POST['Submit']=='Delete')  
	{
	 ...
	 $sql = "DELETE FROM membership_upgrade_master WHERE Membership_Upgrade_Id  in (".$ids.") ";  
	 executeQuery($sql);
	...
	{
	  $sql = "UPDATE membership_upgrade_master  SET Status='1' WHERE Membership_Upgrade_Id  in (".$ids.")";
	  executeQuery($sql);
   ...
   {
    $sql = "UPDATE membership_upgrade_master SET Status='0' WHERE Membership_Upgrade_Id  in (".$ids.")";
    executeQuery($sql);
