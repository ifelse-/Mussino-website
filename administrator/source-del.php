...
if(count($_POST['ids'])>0)
{
	...
	if($_POST['Submit']=='Delete')  
	{
	 ...
	 $sql = "DELETE FROM source_link_master WHERE Source_Id in (".$ids.") ";  
	 executeQuery($sql);
	...
	{
	  $sql = "UPDATE source_link_master  SET Status='1' WHERE Source_Id in (".$ids.")";
	  executeQuery($sql);
   ...
   {
    $sql = "UPDATE source_link_master SET Status='0' WHERE Source_Id in (".$ids.")";
    executeQuery($sql);
