...
if(count($_POST['ids'])>0)
{
	...
	if($_POST['Submit']=='Delete')  
	{
	 ...
	 $sql = "DELETE FROM country_master WHERE Country_Id in (".$ids.") ";  
	 executeQuery($sql);
	...
	{
	  $sql = "UPDATE country_master  SET Status='1' WHERE Country_Id in (".$ids.")";
	  executeQuery($sql);
   ...
   {
    $sql = "UPDATE country_master SET Status='0' WHERE Country_Id in (".$ids.")";
    executeQuery($sql);
