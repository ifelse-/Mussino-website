      ...
      <div class="pro-wrapper full">
        ...
        <form name="form1" method="form1" action="">
          ...
          <tr>
            ...
            <td align="center" width="15%" align="center"><strong>Edit</strong></td>
            </tr>
            <?php
			$ct=0;
			if($reccnt>0) 
            ...
            <td width="15%" align="center" valign="middle"><?=stripslashes(Get_Single_Field("type_master","Type_Name","Type_Id","$line[Type]"));?>  </td>
            
            <td  width="10%" align="center" valign="middle"> <?=get_date_format($line['Product_Date']);?></td>
            <td  width="10%" align="center" valign="middle"> <?=$line['Status']==1?'Active ':'Inactive';?></td>
            <td  width="15%" align="center" valign="middle"> <a href="music-store.php?id=<?=$line['Product_Id']?>"><img src="administrator/images/editrec.gif" width="12" height="12" border="0"> Edit</a></td>
            </tr> 
