<?php
if($reccnt_sound_type3!=0){
$pagenum=$reccnt_sound_type3/$pagesize;
...
<div class="paging">
          ...
          <ul>
			...
			?>
            <?php if($start+$pagesize < $reccnt_sound_type3){ ?><li class="nxt"><a href="<?=$PHP_SELF?><?=$qry_str?>&start=<?=$start+$pagesize?>">Next</a></li><?php } ?>
          </ul>
          <div class="cl"></div>
          </div>
          <div class="cl"></div>
