        ...
        <!-- top-Pannel -->
            ...
            <!-- vedioPrt -->
				<div class="vedioPrt">
                  ...
                  <span><h1 style="display:inline"><?=stripslashes($colles_Product['Title'])?> </h1>&nbsp;
                     <a href="https://twitter.com/share" class="twitter-share-button" data-text="Enter <?=stripslashes($colles_Product['Title'])?> session today. Session ends on <?=get_date_format($colles_Product['Session_End_Date'])?> Signup Free! Mussino.com Virtual Music Industry " data-lang="en">Tweet</a></span>
                ...
                <div class="music-Btn2 session-upload-btn">
...
onKeyUp="textCounter(document.chFrm.Lyrics,document.chFrm.remLen1,1200)"><?=stripslashes($collesTextLyrics['Lyrics'])?></textarea>
           ...
           <!-- <div class="cl"></div>
            ...
            <div class="session-mid-advertisement" style="float:right; width:267px">
             ...
             <br />
             <a  href="https://twitter.com/share" class="twitter-share-button size_small" data-text="Enter <?=stripslashes($colles_Product['Title'])?> session today. Session ends on <?=get_date_format($colles_Product['Session_End_Date'])?> Signup Free! Mussino.com Virtual Music Industry " data-lang="en" style="text-align:center">Tweet to all your followers</a>
             <br />
             
             <div class="music-Btn">
             <a class="size_small" href="http://www.mussino.com/product.php">Create New Session</a>
             </div>
             
             <div class="music-Btn">
             <a class="size_small" href="http://www.mussino.com/music-store.php">Sell Beats</a>
             </div>
             
             <div class="music-Btn">
             <a href="/send_to_friend/popup.php" title="Send to Friend" class="sendtofriend size_small">Send Page To Friend</a>
            
             </div>
             
               <div class="music-Btn">
             <a class="size_small" href="<?=SITE_WS_PATH?>/message.php?uid=<?=md5($_SESSION['SESS_ID'])?>">Invite People</a>
             </div>
            ...
            <div class="music-Btn">
                ...
                <div class="">
                <a class="size_small" id="variousDownload" href="#download_id">Get session beat</a>
                <div style="display: none;">
      ...
      <div class="rgtPannel history info" style="width:500px; float:left">
          ...
          <div class="scroller">
              ...
              <div class="user" style="float:left;"> 
                ...
                <?php } ?>
                 ...
                 <p class="sesuname-title"><?=ucfirst(stripslashes(Get_Single_Field("member_account_master","First_Name","Member_Account_Id","$colles_history_post[Member_Account_Id]")))?></p>
                  ...
                  <div class="cl"></div>
                  <div style=" padding:15px 20px 0 55px; font-size:13px; color:#CCC; float:right">
                   <?=$diff;?>
                  </div>
			...
			$ct++;
                ...
                <?php if($_SESSION['SESS_ACCOUNT_TYPE']=='Musician')  { ?>
 <h2>No songwriters yet.<BR /> Use tools below to help get it started.</h2>
 <br />
...
<a href="/send_to_friend/popup.php" target="_blank" title="Send to Friend" class="sendtofriend"> <img src="../images/invite-songwriter.png" /></a>
<a href="https://twitter.com/share" class="twitter popup" data-text="Check out my session on Mussino.com" data-lang="en"><img src="../images/promote-session.png" /></a>                
                
                
                <?php } else {  ?>
                
                
<h2>Be the first to post to this session.<BR /> Use tools below to invite.</h2>
 <br />
...
<a href="https://twitter.com/share" class="twitter popup" data-text="Check out my session on Mussino.com" data-lang="en"><img src="../images/promote-session.png" /></a> 
            ...
            <div class="postBlock" style="float:left; width:100%; padding-top:10px;"> 
           <p class="sesuname-title"><?=ucfirst(stripslashes(Get_Single_Field("member_account_master","First_Name","Member_Account_Id","$collesAudio[Member_Account_Id]")))?></p>
              <div class="user" style="float:left;"> 
            ...
            <div class="postBlock" style="float:left; width:100%; padding-top:10px;"> 
              ...
              <div class="user" style="float:left;"> 
                ...
                <div style="padding-left:65px; padding-right:10px">
               <p class="sesuname-title"><?=ucfirst(stripslashes(Get_Single_Field("member_account_master","First_Name","Member_Account_Id","$collesVideo[Member_Account_Id]")))?></p>
...
<?php */?>
<a class="twitter-timeline"  href="https://twitter.com/MussinoSupport" data-widget-id="273631757524406272">Tweets by @MussinoSupport</a>
<script>!function(d,s,id){var js,fjs=d.getElementsByTagName(s)[0];if(!d.getElementById(id)){js=d.createElement(s);js.id=id;js.src="//platform.twitter.com/widgets.js";fjs.parentNode.insertBefore(js,fjs);}}(document,"script","twitter-wjs");</script>
