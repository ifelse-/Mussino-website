...
class AuthNetCim {
	...
	function parseResults()
	{
		...
		$this->description = $this->substring_between($this->response,'<description>','</description>');
		...
		$this->payment = $this->substring_between($this->response,'<payment>','</payment>');
		$this->creditCard = $this->substring_between($this->response,'<creditCard>','</creditCard>');
