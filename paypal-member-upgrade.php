...
echo"<input type='hidden' name='amount' value='".trim($_SESSION['up_amount'])."'/>";
...
echo"<input type='hidden' name='return' value='http://localhost/music_site/upgrade-membership-invoice.php'>";
echo "</form>";
