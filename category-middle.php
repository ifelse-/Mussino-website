    ...
    <div class="content-box-2">
        ...
        <div class="genre-wrap full">
          <div class="genre-col">
            ...
            <?php
			$sql_sound_type1 = "SELECT * FROM product_master WHERE Category_Id='".$_REQUEST['id']."' AND Type=3";
            ...
            <div class="genre-block">
              ...
              <div class="gray-btn-2">
                <a href="product.php?Product_Id=<?=$colles_sound_type1['Product_Id']?>">Edit Me</a>
              </div>
              <?php } else { ?>
              <div class="gray-btn-2">
