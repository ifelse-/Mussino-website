<?php
if($reccnt_sound_type2!=0){
$pagenum=$reccnt_sound_type2/$pagesize;
...
<div class="paging">
          ...
          <ul>
			...
			?>
            <?php if($start+$pagesize < $reccnt_sound_type2){ ?><li class="nxt"><a href="<?=$PHP_SELF?><?=$qry_str?>&start=<?=$start+$pagesize?>">Next</a></li><?php } ?>
          </ul>
          <div class="cl"></div>
          </div>
          <div class="cl"></div>
